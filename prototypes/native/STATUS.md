...
Live cancellation probe: cancelled during real nested judgment, then /quit; CLI exited promptly and all 9 observed owned PIDs were gone. Initialization cancellation now owns the Codex client before awaiting the handshake and shutdown has a bounded interrupt/grace period.
